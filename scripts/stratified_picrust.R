...
# Normalize pathways, grouping by function and sample for proportion of taxa relative abundance
...
# Group by function and taxon, calculate mean proportion of reads 
